...
{ name='allcompletehistory', type='map', key='int', value='int'},
...
msg.add_type('lx.gs.redpacket.msg', {
name='SNewRedPackage',
id=6554410,
{ name='redpackage', type='lx.gs.redpacket.msg.RedpacketInfo'},
})
msg.add_type('lx.gs.redpacket.msg', {
name='SDelRedPackage',
id=6554411,
{ name='delredpackages', type='list', value='int'},
})
...
msg.add_type('lx.gs.bonus.msg', {
name='CGetSupremeCardGift',
id=6556114,
{ name='date', type='int'},
})
msg.add_type('lx.gs.bonus.msg', {
name='SGetSupremeCardGift',
id=6556115,
{ name='date', type='int'},
{ name='supremecardgift', type='map.msg.Bonus'},
})
msg.add_type('lx.gs.bonus.msg', {
name='CGetOnlineGift',
id=6556116,
...
name='CTreasureBowlCompositeAll',
id=6564034,
{ name='isgemstone', type='int'},
{ name='index', type='int'},
{ name='unbind', type='int'},
})
msg.add_type('lx.gs.family.msg', {
name='SGetFamilyWarStatus2',
id=6564057,
{ name='battleid', type='int'},
{ name='result', type='byte'},
{ name='status1', type='map.msg.FamilyWarBattleFieldStatus'},
{ name='status2', type='map.msg.FamilyWarBattleFieldStatus'},
{ name='remaintime', type='long'},
})
msg.add_type('lx.gs.family.msg.citywar', {
name='CGetAllCitys',
id=6564115,
})
msg.add_type('lx.gs.family.msg', {
...
msg.add_type('lx.gs.family.msg.citywar', {
name='SGetAllLuckyBonusInfo',
id=6564430,
{ name='citybonus', type='map', key='int', value='map.msg.Bonus'},
})
msg.add_type('lx.gs.friend.msg', {
name='SGetReceiveFlowerInfo',
id=6564488,
{ name='info', type='list', value='lx.gs.friend.msg.FlowersInfo'},
})
msg.add_type('lx.gs.map.msg', {
...
name='SPetRecycle',
id=6566056,
{ name='newpet', type='lx.gs.pet.Pet'},
})
msg.add_type('lx.gs.treasurebowl', {
...
msg.add_type('lx.gs.family.msg', {
name='SGetFamilyWarStatus',
id=6566138,
{ name='onlinemembernum', type='int'},
})
msg.add_type('lx.gs.bag.msg', {
name='SSyncCapacity',
id=6566173,
...
name='SGetAllCitys',
id=6566266,
{ name='citys', type='list', value='lx.gs.family.msg.citywar.City'},
})
msg.add_type('lx.gs.task.msg', {
...
msg.add_type('lx.gs.map.msg', {
name='SSweepPersonalBossEctype',
id=6566358,
{ name='ectypeid', type='int'},
{ name='bonus', type='map.msg.Bonus'},
})
msg.add_type('lx.gs.role.msg', {
name='SCanReturnToRevivePos',
id=6566519,
{ name='remaintime', type='long'},
})
msg.add_type('lx.gs.marriage.msg', {
...
msg.add_type('lx.gs.treasurebowl', {
name='STreasureBowlComposite',
id=6566616,
{ name='isgemstone', type='int'},
{ name='index', type='int'},
})
msg.add_type('lx.gs.family.msg', {
name='CGetFamilyWarCandidateList',
id=6566624,
{ name='startindex', type='int'},
...
msg.add_type('lx.gs.family.msg', {
name='SGetFamilyRoundMatchStatus',
id=6566830,
{ name='battleid', type='int'},
{ name='result', type='int'},
{ name='status1', type='map.msg.FamilyWarBattleFieldStatus'},
{ name='animal1id', type='int'},
{ name='animal1level', type='int'},
{ name='status2', type='map.msg.FamilyWarBattleFieldStatus'},
{ name='animal2id', type='int'},
{ name='animal2level', type='int'},
{ name='remaintime', type='long'},
})
msg.add_type('lx.gs.pay', {
...
name='SFamilyWarInfo',
id=6567034,
{ name='info', type='lx.gs.family.msg.FamilyWarInfo'},
})
...
{ name='activeawake', type='int'},
{ name='activestar', type='list', value='int'},
})
msg.add_type('lx.gs.pickcard.msg', {
...
msg.add_type('lx.gs.redpacket.msg', {
name='SGetMoneyNotify',
id=6568801,
{ name='redpacketinfo', type='lx.gs.redpacket.msg.RedpacketInfo'},
})
msg.add_type('lx.gs.pet.msg', {
name='CEquipPetSkin',
id=6568809,
...
msg.add_type('lx.gs.pay', {
name='SBuySupremeCardNotify',
id=6568968,
{ name='buysupremecardtime', type='int'},
{ name='supremecardleftdays', type='int'},
})
msg.add_type('lx.gs.marriage.msg', {
...
msg.add_type('lx.gs.bonus.msg', {
name='SGetWholePeopleBonus',
id=6569018,
{ name='result', type='int'},
{ name='bonusid', type='int'},
})
msg.add_type('lx.gs.friend.msg', {
...
msg.add_type('lx.gs.family.msg', {
name='SNewFamilyWarMyChallenge',
id=6569196,
{ name='opponentfamilyid', type='long'},
})
msg.add_type('lx.gs.family.msg', {
...
msg.add_type('lx.gs.map.msg', {
name='SGetHeroEctypeUnlock',
id=6569382,
{ name='unlockinfos', type='map', key='int', value='int'},
})
msg.add_type('lx.gs.family.msg', {
...
msg.add_type('lx.gs.role.msg', {
name='CCanReturnToRevivePos',
id=6569630,
})
msg.add_type('lx.gs.friend.msg', {
name='CGetSendFlowerInfo',
id=6569767,
})
...
id=6570476,
{ name='city', type='int'},
{ name='totalmoney', type='long'},
})
msg.add_type('lx.gs.treasurebowl', {
name='CTreasureBowlComposite',
id=6570494,
{ name='isgemstone', type='int'},
{ name='index', type='int'},
{ name='unbind', type='int'},
...
msg.add_type('lx.gs.map.msg', {
name='CSweepPersonalBossEctype',
id=6570860,
{ name='ectypeid', type='int'},
})
msg.add_type('lx.gs.map.msg', {
name='SSweepDailyEctype',
id=6570862,
{ name='ectypetype', type='int'},
{ name='bonus', type='map.msg.Bonus'},
})
...
msg.add_type('lx.gs.family.msg', {
name='SNewFamilyWarHistory',
id=6571582,
{ name='history', type='lx.gs.family.msg.FamilyWarHistory'},
})
msg.add_type('lx.gs.bag.msg', {
name='CSyncItems',
id=6571587,
...
name='SGetBattleLog',
id=6571811,
{ name='logs', type='list', value='lx.gs.family.msg.citywar.BattleLog'},
})
msg.add_type('lx.gs.chat.msg', {
...
msg.add_type('lx.gs.login', {
name='Scanfirstrecharge',
id=6572011,
{ name='canfirstrecharge', type='int'},
})
msg.add_type('lx.gs.map.msg', {
...
msg.add_type('lx.gs.family.msg', {
name='CFamilyDepotEquipGive',
id=6572471,
{ name='itemid', type='long'},
{ name='recieveid', type='long'},
})
msg.add_type('lx.gs.map.msg', {
...
name='SGetMyBattles',
id=6572869,
{ name='battlestatus', type='map', key='int', value='lx.gs.family.msg.citywar.BattleInfo'},
})
msg.add_type('lx.gs.map.msg', {
...
msg.add_type('lx.gs.redpacket.msg', {
name='SRedPackageNotify',
id=6574065,
{ name='packageid', type='int'},
{ name='sendername', type='string'},
{ name='senderid', type='long'},
{ name='packagetype', type='int'},
{ name='channeltype', type='int'},
})
msg.add_type('lx.gs.family.msg', {
name='SFamilyWarInfo2',
id=6574117,
{ name='info', type='lx.gs.family.msg.FamilyWarInfo'},
{ name='histories', type='list', value='lx.gs.family.msg.FamilyWarHistory'},
{ name='challengemes', type='list', value='lx.gs.family.msg.FamilyWarChallenge'},
})
msg.add_type('lx.gs.family.msg', {
name='CEnterFamilyWar',
id=6574184,
{ name='battlefieldid', type='int'},
})
msg.add_type('lx.gs.task.msg', {
...
msg.add_type('lx.gs.bonus.msg', {
name='SGetTimeLimitBonus',
id=6576970,
{ name='result', type='int'},
{ name='giftid', type='int'},
...
msg.add_type('lx.gs.family.msg', {
name='SNewFamilyWarChallengeMe',
id=6578456,
{ name='challenge', type='lx.gs.family.msg.FamilyWarChallenge'},
})
msg.add_type('lx.gs.family.msg', {
...
{ name='owncitys', type='list', value='int'},
{ name='declarewarcity', type='int'},
{ name='declaremoney', type='long'},
{ name='luckybonus', type='map.msg.Bonus'},
})
msg.add_type('lx.gs.friend.msg', {
name='SSendFlower',
id=6578792,
...
{ name='position', type='map.msg.Vector2'},
})
msg.add_type('lx.gs.friend.msg', {
name='SDeleteMM',
id=6579603,
...
msg.add_type('lx.gs.family.msg', {
name='CChangeFamilyNameNeedYuanbao',
id=6580213,
})
msg.add_type('lx.gs.family.msg', {
...
msg.add_type('lx.gs.treasurebowl', {
name='STreasureBowlCompositeAll',
id=6580984,
{ name='isgemstone', type='int'},
{ name='index', type='int'},
{ name='num', type='int'},
...
name='SAllocBonus',
id=6582275,
{ name='remainbonus', type='map.msg.Bonus'},
})
msg.add_type('lx.gs.marriage.msg', {
...
msg.add_type('lx.gs.chat.msg', {
name='SGetRoleChatShowInfos',
id=6582665,
{ name='roles', type='map', key='long', value='lx.gs.chat.msg.RoleChatShowInfo'},
})
msg.add_type('lx.gs.map.msg', {
name='CEnterWorld',
id=6582681,
...
name='SGetAllocLog',
id=6583042,
{ name='logs', type='list', value='lx.gs.family.msg.citywar.AllocLog'},
})
msg.add_type('lx.gs.marriage.msg', {
name='SFriendWish',
id=6583044,
...
{ name='isactivepay', type='int'},
{ name='isactivechargepay', type='int'},
{ name='wishtimes', type='int'},
{ name='lastwishtime', type='long'},
{ name='lastwishpetid', type='long'},
{ name='iseatlunch', type='int'},
{ name='iseatdinner', type='int'},
{ name='supremecradplayer', type='int'},
{ name='isrecievesupremecard', type='int'},
{ name='buygrowplannum', type='int'},
{ name='hasrecievewholepeoplebonus', type='list', value='int'},
{ name='hasgottimelimitgift', type='map', key='int', value='int'},
})
msg.add_type('lx.gs.family.msg', {
...
msg.add_type('lx.gs.family.msg.citywar', {
name='SChangeLogoName',
id=6584876,
{ name='name', type='string'},
})
msg.add_type('lx.gs.family.msg', {
name='SChangeFamilyNameNeedYuanbao',
id=6584880,
{ name='needyuanbao', type='long'},
})
msg.add_type('lx.gs.family.msg', {
name='SPutEquipToFamilyDepot',
id=6584967,
})
msg.add_type('lx.gs.marriage.msg', {
...
msg.add_type('lx.gs.family.msg', {
name='SGetFamilyWarCandidateList',
id=6585703,
{ name='totalnum', type='int'},
{ name='startindex', type='int'},
{ name='families', type='list', value='lx.gs.family.msg.FamilyWarToChallenge'},
})
msg.add_type('lx.gs.map.msg', {
...
msg.add_type('lx.gs.family.msg', {
name='SGetFamilyDepot',
id=6586119,
{ name='capacity', type='int'},
{ name='familydepot', type='map', key='int', value='lx.gs.equip.Equip'},
})
msg.add_type('lx.gs.task.msg', {
...
id=6684774,
{ name='position', type='map.msg.Vector2'},
{ name='orient', type='float'},
})
msg.add_type('map.msg', {
name='CMove',
id=6684775,
{ name='position', type='map.msg.Vector2'},
{ name='target', type='map.msg.Vector2'},
})
msg.add_type('map.msg', {
name='SMove',
id=6684776,
...
msg.add_type('map.msg', {
name='SFamilyWarStatus',
id=6695091,
{ name='status1', type='map.msg.FamilyWarStatus'},
{ name='status2', type='map.msg.FamilyWarStatus'},
})
msg.add_type('map.msg', {
name='SNewWaveOpen',
id=6695111,
...
msg.add_type('map.msg', {
name='SFamilyWarScore',
id=6695238,
{ name='myfamilyscore', type='int'},
{ name='opponentscore', type='int'},
{ name='familyid', type='long'},
})
msg.add_type('map.msg', {
name='MWorldPKKill',
...
msg.add_type('map.msg', {
name='SBeginTransform',
id=6697002,
{ name='petid', type='long'},
{ name='effectid', type='int'},
{ name='remaintime', type='float'},
})
msg.add_type('map.msg', {
name='SEndFamilyWar',
id=6697108,
{ name='iswin', type='byte'},
{ name='familybuilddegree', type='int'},
{ name='bonus', type='map.msg.Bonus'},
})
msg.add_type('map.msg', {
name='XCreateFamilyWar',
id=6697142,
{ name='serverid', type='int'},
{ name='isattack', type='byte'},
{ name='battleid', type='byte'},
{ name='remaintime', type='long'},
{ name='family1', type='map.msg.FamilyWarInfo'},
{ name='family2', type='map.msg.FamilyWarInfo'},
})
msg.add_type('map.msg', {
...
msg.add_type('map.msg', {
name='XCreateNpcAtPlayerPosition',
id=6699542,
{ name='idnpc', type='int'},
})
msg.add_type('map.msg', {
...
msg.add_type('map.msg', {
name='SChangeEffectAttrs',
id=6701082,
{ name='attrs', type='map', key='int', value='float'},
})
msg.add_type('map.msg', {
name='MGetFamilyWarPlayerCount',
id=6701183,
{ name='result', type='int'},
{ name='num', type='int'},
{ name='familyid', type='long'},
{ name='family1', type='long'},
{ name='family2', type='long'},
{ name='battleid', type='int'},
{ name='roleid', type='long'},
{ name='mapid', type='long'},
})
msg.add_type('map.msg', {
name='XCreateFamilyCityWar',
id=6701200,
{ name='serverid', type='int'},
{ name='city', type='int'},
{ name='money', type='long'},
{ name='defencefamily', type='map.msg.FamilyCityWarFamilyInfo'},
{ name='attackfamily', type='map.msg.FamilyCityWarFamilyInfo'},
{ name='remaintime', type='long'},
{ name='steadyfamilyid', type='long'},
})
msg.add_type('map.msg', {
name='SBeSkillAttack',
id=6701442,
...
id=6702843,
{ name='teams', type='map', key='int', value='map.msg.TeamStatistic'},
})
msg.add_type('map.msg', {
name='SEndGuardTower',
id=6702857,
...
id=6703897,
{ name='bonus', type='map.msg.Bonus'},
{ name='vector2', type='map.msg.Vector2'},
})
msg.add_type('map.msg', {
name='SNewFloorOpen',
id=6703937,
...
name='CFindPath',
id=6703967,
{ name='src', type='map.msg.Vector2'},
{ name='dst', type='map.msg.Vector2'},
})
msg.add_type('map.msg', {
...
{ name='battleid', type='int'},
{ name='familyid', type='long'},
{ name='family1', type='map.msg.FamilyWarBattleFieldStatus'},
{ name='family2', type='map.msg.FamilyWarBattleFieldStatus'},
})
msg.add_type('map.msg', {
name='SEffectRevive',
id=6705342,
...
id=6706212,
{ name='portalid', type='int'},
{ name='curposition', type='map.msg.Vector2'},
{ name='dstposition', type='map.msg.Vector2'},
...
msg.add_type('map.msg', {
name='SEndFamilyCityWar',
id=6708038,
{ name='isdefence', type='byte'},
{ name='win', type='byte'},
{ name='money', type='long'},
})
msg.add_type('map.msg', {
...
msg.add_type('map.msg', {
name='MEatFamilyParty',
id=6708948,
})
msg.add_type('map.msg', {
name='SFindPath',
id=6708970,
{ name='path', type='list', value='map.msg.Vector2'},
})
msg.add_type('map.msg', {
...
msg.add_type('map.msg', {
name='SFamilyCityWarScore',
id=6709318,
{ name='myfamilyscore', type='int'},
{ name='opponentscore', type='int'},
{ name='towers', type='map', key='int', value='map.msg.TowerInfo'},
})
msg.add_type('map.msg', {
name='SCountDown',
id=6709421,
...
msg.add_type('map.msg', {
name='MEndAllFamilyWar',
id=6709557,
{ name='battleid', type='int'},
{ name='result', type='byte'},
{ name='family1', type='map.msg.FamilyWarEndInfo'},
{ name='family2', type='map.msg.FamilyWarEndInfo'},
})
msg.add_type('map.msg', {
name='XRpc',
id=6709628,
...
{ name='skillid', type='int'},
{ name='targetid', type='long'},
{ name='direction', type='map.msg.Vector2'},
})
msg.add_type('map.msg', {
...
msg.add_type('map.msg', {
name='SEnterFamilyCityWar',
id=6711127,
{ name='city', type='int'},
{ name='defencecamp', type='int'},
{ name='defencefamilyid', type='long'},
{ name='defencefamilyname', type='string'},
{ name='attackcamp', type='int'},
{ name='attackfamilyid', type='long'},
{ name='attackfamilyname', type='string'},
{ name='remaintime', type='long'},
})
msg.add_type('map.msg', {
...
msg.add_type('map.msg', {
name='MEndFamilyCityWar',
id=6714199,
{ name='city', type='int'},
{ name='money', type='long'},
{ name='attackwin', type='byte'},
{ name='defencefamilyid', type='long'},
{ name='attackfamilyid', type='long'},
})
msg.add_type('map.msg', {
...
msg.add_type('map.msg', {
name='MGetCityWarStatus',
id=6714829,
{ name='city', type='int'},
{ name='defencemembernum', type='int'},
{ name='attackmembernum', type='int'},
})
msg.add_type('map.msg', {
name='SCurveFlyBegin',
id=6714969,
...
msg.add_type('lx.gs.chat.msg', {
name='RoleChatShowInfo',
{ name='name', type='string'},
{ name='gender', type='int'},
{ name='profession', type='int'},
{ name='level', type='int'},
{ name='viplevel', type='int'},
{ name='isonline', type='byte'},
})
msg.add_type('lx.gs.dailyactivity.msg', {
name='Findbacktype',
JINBI_FIND = 1,
...
msg.add_type('lx.gs.family.msg', {
name='FamilyWarChallenge',
{ name='showinfo', type='lx.gs.family.msg.FamilyWarShowInfo'},
{ name='expiretime', type='long'},
})
msg.add_type('lx.gs.family.msg', {
name='FamilyWarHistory',
{ name='familyname', type='string'},
{ name='level', type='int'},
{ name='result', type='byte'},
{ name='time', type='long'},
{ name='challengeme', type='byte'},
})
msg.add_type('lx.gs.family.msg', {
name='FamilyWarInfo',
{ name='todayfamilywarnum', type='int'},
{ name='isinwar', type='byte'},
{ name='myanimalid', type='int'},
{ name='myanimallevel', type='int'},
{ name='opponentfamilyname', type='string'},
{ name='opponentfamilylevel', type='int'},
{ name='opponentanimalid', type='int'},
{ name='opponentanimallevel', type='int'},
{ name='winnum', type='int'},
{ name='drawnum', type='int'},
{ name='losenum', type='int'},
})
msg.add_type('lx.gs.family.msg', {
name='FamilyWarShowInfo',
{ name='id', type='long'},
{ name='familyname', type='string'},
{ name='chiefname', type='string'},
{ name='level', type='int'},
{ name='totalmembernum', type='int'},
{ name='winnum', type='int'},
{ name='drawnum', type='int'},
{ name='losenum', type='int'},
})
msg.add_type('lx.gs.family.msg', {
name='FamilyWarToChallenge',
{ name='showinfo', type='lx.gs.family.msg.FamilyWarShowInfo'},
{ name='canchallenge', type='byte'},
})
msg.add_type('lx.gs.family.msg.citywar', {
name='AllocLog',
{ name='name', type='string'},
...
name='City',
{ name='city', type='int'},
{ name='ispeace', type='byte'},
{ name='timerangeindex', type='int'},
{ name='defencefamilyid', type='long'},
{ name='defencefamilyname', type='string'},
{ name='defencecolor', type='int'},
{ name='attackfamilyid', type='long'},
{ name='attackfamilyname', type='string'},
{ name='attackcolor', type='int'},
{ name='logoname', type='string'},
{ name='stability', type='int'},
{ name='oldfamilyid', type='long'},
{ name='oldfamilyname', type='string'},
})
msg.add_type('lx.gs.fragment', {
name='Fragment',
...
{ name='worldlevelrate', type='float'},
})
msg.add_type('lx.gs.mail.msg', {
name='Mail',
{ name='id', type='int'},
...
{ name='packagetype', type='int'},
{ name='sendername', type='string'},
{ name='sendertime', type='long'},
{ name='records', type='list', value='lx.gs.redpacket.msg.recordsInFo'},
})
msg.add_type('lx.gs.redpacket.msg', {
name='recordsInFo',
{ name='rolename', type='string'},
{ name='bonus', type='map.msg.Bonus'},
{ name='currency', type='map', key='int', value='int'},
})
msg.add_type('lx.gs.role.msg', {
...
msg.add_type('map.msg', {
name='FamilyCityWarFamilyInfo',
{ name='familyid', type='long'},
{ name='familyname', type='string'},
{ name='familylevel', type='int'},
{ name='familybossid', type='int'},
{ name='familybosslevel', type='int'},
{ name='stability', type='int'},
})
msg.add_type('map.msg', {
...
msg.add_type('map.msg', {
name='FamilyWarBattleFieldStatus',
{ name='familyid', type='long'},
{ name='membernum', type='int'},
{ name='score', type='int'},
{ name='remaintowers', type='list', value='int'},
})
msg.add_type('map.msg', {
name='FamilyWarEndInfo',
{ name='familyid', type='long'},
})
msg.add_type('map.msg', {
name='FamilyWarInfo',
...
{ name='familyname', type='string'},
{ name='familylevel', type='int'},
{ name='topmemberlevel', type='int'},
{ name='animalid', type='int'},
{ name='animallevel', type='int'},
})
msg.add_type('map.msg', {
name='FamilyWarStatus',
{ name='familyid', type='long'},
{ name='familyname', type='string'},
{ name='score', type='int'},
{ name='towerhps', type='list', value='float'},
})
msg.add_type('map.msg', {
name='FighterBuilder',
...
{ name='position', type='map.msg.Vector2'},
{ name='orient', type='float'},
{ name='targetposition', type='map.msg.Vector2'},
{ name='skills', type='map', key='int', value='int'},
{ name='attrs', type='map', key='int', value='float'},
})
msg.add_type('map.msg', {
...
{ name='attrs', type='list', value='float'},
{ name='buffs', type='list', value='int'},
{ name='defaultrelateownerorient', type='float'},
{ name='defaultrelateownerdistance', type='float'},
...
msg.add_type('map.msg', {
name='TowerInfo',
{ name='addscore', type='int'},
{ name='players', type='set', value='long'},
{ name='defencenum', type='int'},
{ name='attacknum', type='int'},
})
msg.add_type('map.msg', {
name='Vector2',
{ name='x', type='float'},
