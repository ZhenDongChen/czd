...
CameraPath.LoadFunction = function(self)
    self.CurrentTime = 0
    self.CurrentState = PlotDefine.ElementState.Loaded
end

CameraPath.StartFunction = function(self)
    --local cameraObj = self.Cutscene.CurrentCamera.gameObject
...
CameraPath.SetPositionOfTime = function(self)
...
CameraPath.LoopFunction = function(self,deltaTime)
	self.CurrentTime = self.CurrentTime + deltaTime;
    self:SetPositionOfTime()
end
CameraPath.EndFunction = function(self)
    self.CurrentTime = self.Duration
    self:SetPositionOfTime()
    self.CurrentState = PlotDefine.ElementState.Ended
end
CameraPath.SampleFunction = function(self,time)
