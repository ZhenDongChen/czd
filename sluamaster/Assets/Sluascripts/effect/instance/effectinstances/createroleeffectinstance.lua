...
local CreatRoleEffectInstance = Class:new(EffectInstance)



function CreatRoleEffectInstance:CheckCanShow()
    if uimanager.hasloaded "dlgcreatplayer" == false then
        return false
    end
    local dlgcreatplayer  = require"ui.dlgcreatplayer"
    local  playerObj =  dlgcreatplayer.getPlayerObj()
    if playerObj ==nil or
...
function CreatRoleEffectInstance:GenBornPosition()
...
function CreatRoleEffectInstance:UpdateTransform()
    local dlgcreatplayer  = require"ui.dlgcreatplayer"
    local  playerObj =  dlgcreatplayer.getPlayerObj()
    self:UpdateRotation()
...
function CreatRoleEffectInstance:UpdateRotation()
...
function CreatRoleEffectInstance:Update()
...
return CreatRoleEffectInstance
